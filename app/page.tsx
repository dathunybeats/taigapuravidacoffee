        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 sm:gap-16 items-center">
          ...
          <ScrollReveal delay={150}>
            <div>
              ...
              <h2 className="text-[#EDD9B8] leading-tight text-4xl sm:text-5xl mb-6">
              ...
              <ul className="space-y-3.5 mb-10">
                {whatWeBringCategories.map((cat) => (
                  <li key={cat} className="flex items-center gap-3">
                    ...
                    <span className="text-[#EDD9B8]/70 text-sm font-light">{cat}</span>
                  </li>
                ))}
              </ul>
              ...
              <a
                href="#quote"
                className="inline-flex items-center bg-[#C4622D] text-white px-7 py-3.5 rounded-full sweep-btn"
                style={{ ...btnStyle, "--sweep-bg": "#E07832" } as React.CSSProperties}
              >
