  ...
  return (
    <header className="sticky top-0 z-50 bg-[#2B1608]">
      ...
      <div className="px-5 sm:px-12 py-4 sm:py-5 flex items-center justify-between">
        ...
        {/* Desktop nav — Home is active on homepage */}
        <nav className="hidden sm:flex items-center gap-8" aria-label="Main navigation">
          <a href="/"         className="text-[#EDD9B8] transition-colors"           style={navStyle}>Home</a>
          <a href="/about"    className="text-[#EDD9B8]/60 hover:text-[#EDD9B8] transition-colors" style={navStyle}>About</a>
          <a href="/services" className="text-[#EDD9B8]/60 hover:text-[#EDD9B8] transition-colors" style={navStyle}>Services</a>
          <a href="/contact"  className="text-[#EDD9B8]/60 hover:text-[#EDD9B8] transition-colors" style={navStyle}>Contact</a>
        </nav>

        {/* Desktop CTA — scrolls to on-page form */}
        <a
          href="#quote"
        ...
        >
          {links.map(({ href, label }) => (
            <a
              ...
              className={`py-4 border-b border-[#EDD9B8]/10 text-sm transition-colors ${
                href === "/" ? "text-[#EDD9B8]" : "text-[#EDD9B8]/60 hover:text-[#EDD9B8]"
              }`}
              style={navStyle}
            >
              {label}
